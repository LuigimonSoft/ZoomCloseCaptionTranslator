...
namespace ZOOM_SDK_DOTNET_WRAP {
	...
	IMeetingClosedCaptionControllerDotNetWrap^ CZoomSDKeDotNetWrap::GetMeetingClosedCaptionControllerWrap()
	{
		if (CMeetingClosedCaptionControllerDotNetWrap::Instance)
		{
			CMeetingClosedCaptionControllerDotNetWrap::Instance->BindEvent();
		}

		return CMeetingClosedCaptionControllerDotNetWrap::Instance;
	}
}